...
namespace BandObjectLib
{
	...
	/// { /*...*/ }
	/// </example>
	public class BandObject : UserControl, IObjectWithSite, IDeskBand2, IDockingWindow, IOleWindow, IInputObject 
	{
        ...
        public virtual int GetCompositionState(out bool pfCompositionEnabled)
        {
        ...
        /// Not used.
        /// </summary>
        public virtual int ResizeBorderDW(IntPtr prcBorder, Object punkToolbarSite, bool fReserved)
        {
            return E_NOTIMPL;
        }
        ...
        public int ResizeBorderDW(RECT rcBorder, IntPtr punkToolbarSite, bool fReserved)
        {
            return E_NOTIMPL;
        }
